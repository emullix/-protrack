                    ...
                    return (
                      <div className="mb-4 bg-slate-50 p-3 rounded-lg border border-slate-100 flex items-center justify-between">
                        <div className="min-w-0 flex-1 pr-2">
                          <p className="text-xs text-slate-700 font-semibold truncate" title={nextTask.name}>{nextTask.name}</p>
                        </div>
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="flex flex-col gap-1 w-full max-w-[150px]">
                            {nextTask && (
                              <span className="text-[10px] text-slate-500 truncate max-w-[120px] font-medium" title={nextTask.name}>
                                {nextTask.name}
                              </span>
                            )}
                            <div className="flex items-center gap-3">
